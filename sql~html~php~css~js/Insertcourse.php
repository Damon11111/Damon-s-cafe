...
<div id="Insert" class="tabcontent">
        ...
        <form  method="POST">
          ...
          <br>
          <label for="instrcutor_Id">Instructor_Id:</label>
          <br>
        ...
        <?php
            ...
            if(isset($_POST['insert']))
            {
                ...
                $query="INSERT INTO course(ID,instrcutor_Id,course_name,credit_hour,prerequisite,start_time,end_time) VALUES('$ID','$instrcutor_Id','$course_name','$credit_hour','$prerequisite','$start_time','$end_time')";
